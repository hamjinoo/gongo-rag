...
| 검색 | Kiwi BM25 + E5/Chroma + chunk ID 기반 RRF 통합 검색 | CrossEncoder reranking |
...
1. CrossEncoder reranking 전후 성능·지연 비교하기
2. LangGraph 재검색·거절 흐름 구현하기
3. Ragas·수동 검토를 포함한 평가표 작성하기
4. FastAPI·Docker와 재현 가능한 실행 환경 제공하기
