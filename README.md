...
이어서 같은 화면에서 문단 우선 또는 고정 길이 방식으로 chunk를 만들고
metadata를 확인할 수 있습니다. 자세한 학습 내용은
[2번 작업: 긴 글을 검색용 조각으로 나누기](docs/CHUNKING.md)에 정리했습니다.
업로드한 chunk를 ChromaDB 검색 색인에 자동 저장하는 일은 다음 단계입니다.
...
2. BM25 기준선에 새 chunk와 metadata 연결하기
3. embedding을 만들고 ChromaDB에 저장·검색하기
