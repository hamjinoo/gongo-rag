...
확인할 수 있습니다. 4.20초도 실시간 서비스에는 부담이 있으므로 다음을 비교합니다.
...
> 평균 지연을 4.20초로 33.1% 줄여 현재 기본값으로 선택했습니다. BM25는 Hit@1
...
느립니다. 더 작은 모델, GPU·최적화, Cohere를 같은 dev 질문으로 비교해야 합니다.
...
더 작은 로컬 reranker와 Cohere를 현재 후보 7개 조건으로 비교한 뒤, 선택한 검색
